...
public class BoardController {
	...
	public String registerPOST(BoardVO board,RedirectAttributes rttr)throws Exception{
		...
		rttr.addFlashAttribute("msg","SUCCESS");//숨겨진 데이터 형태로 전달.
	...
	public String modifyPagePOST(BoardVO board,Criteria cri, RedirectAttributes rttr) throws Exception{
		...
		if(!checkpass.equals(board.getPassword())) {
			...
			rttr.addFlashAttribute("msg","FAIL");
			return "redirect:/board/modifyPage?bno="+board.getBno();
		}
		service.modify(board);
		rttr.addFlashAttribute("msg","SUCCESS");
		return "redirect:/board/listPage";
	...
	public String remove(BoardVO board, Criteria cri, RedirectAttributes rttr) throws Exception{
